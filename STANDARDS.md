...
> **Diperbarui:** 2026-09-16 (sweep akhir: ukuran build, kepemilikan header, status penundaan).
...
| Build & release | ✅ | Reproducible (`pubspec.lock`), 286K total, zero `.js`, versi `1.0.0` |
...
| Accessibility | ✅ | Skip-link, `:focus-visible`, kontras AA terukur di 13/13 halaman, nav mobile 44px |
...
| Ukuran terukur | ✅ 286K total: 13 HTML 108K, font 99K, CSS 25K, ikon + OG 49K |
...
| Kontras AA terukur | ✅ ink 15.45, ink-2 7.60, ink-3 5.55, accent 4.98 (paper); on-dark 10.67, on-dark-2 5.40, signal 4.72 large (ink). Diukur di browser di 13 halaman × 4 lebar = 52 kombinasi, 2345 elemen berteks, 0 gagal |
| Nav mobile + tap target 44px | ✅ header bertumpuk di bawah 640px. ⚠️ Link di footer dan `Back to home` tinggi 17px (<44px), belum diperbaiki |
